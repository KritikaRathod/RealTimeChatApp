      ...
      <div className='w-[500px] h-[600px] bg-white rounded-lg shadow-gray-400 shadow-lg flex flex-col gap-[30px]'>
        ...
        <form className='w-full flex flex-col gap-[20px] items-center'onSubmit={handlesignup}>
          ...
          <input
            ...
            className='w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-white rounded-lg shadow-gray-200 shadow-lg text-gray-700 text-[19px]' onChange={(e)=>setuserName(e.target.value)} value={userName} />
          ...
          <div className='w-[90%] h-[50px] border-2 border-[#20c7ff] overflow-hidden rounded-lg  shadow-gray-200 shadow-lg relative'>
            <input
              ...
              className='w-[90%] h-[50px] outline-none  px-[20px] py-[10px] bg-white  text-gray-700 text-[19px]'onChange={(e)=>setpassword(e.target.value)}value={password} />
          ...
          <button className='p-[20px] py-[10px] bg-[#20c7ff] rounded-2xl shadow-gray-200 shadow-lg text-[20px] w-[200px] mt-[20px] font-semibold hover:shadow-inner'>signup</button>
